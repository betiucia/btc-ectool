const translations = {
    pt: {
        ...
        err_api_key: "Erro: API Key não configurada!", err_ai_call: "Erro na chamada da IA.", err_fill_name: "Preencha o nome primeiro.", toast_generating_desc: "✨ Gerando descrição...", toast_desc_generated: "Descrição gerada!", toast_generating_recipe: "✨ Criando receita...", toast_recipe_added: "Receita sugerida adicionada!", err_ai_recipe: "Erro ao processar receita da IA.", toast_no_export: "Nenhum item/craft encontrado para exportar.", toast_copied_clipboard: "{0} Itens/Crafts copiados para a área de transferência!", alert_not_craftable: "Este item não é craftável, não há receita para exportar.", alert_add_variant: "Adicione pelo menos uma variante de craft.", toast_restore_success: "Dados restaurados com sucesso!", err_invalid_file: "Arquivo inválido!", err_read_file: "Erro ao ler arquivo!", lbl_framework: "Framework do Servidor", header_framework_data: "Dados da Framework ({0})", btn_export_item_def: "Exportar Item ({0})", lbl_weight: "Peso (Weight)", lbl_limit: "Limite (Limit)", lbl_type: "Tipo (Type)", lbl_unique: "Único (Unique)", lbl_usable: "Usável (Usable)", lbl_can_remove: "Removível (Can Remove)", lbl_decay: "Decaimento (Decay)", lbl_delete: "Deletar (Delete)", lbl_should_close: "Fechar Menu (Should Close)", lbl_group_id: "Group ID", lbl_db_id: "DB ID (Opcional)", lbl_degradation: "Degradation", btn_clear_all: "🗑️ Limpar Todos os Itens", confirm_clear_all: "Tem certeza absoluta? Isso apagará TODOS os dados e não pode ser desfeito.", toast_cleared: "Todos os dados foram removidos.", tooltip_export_all_items: "Exportar TODOS os itens (Framework)", tooltip_api_key: "A Chave API conecta o app à IA do Google. Clique para obter a sua gratuitamente.", tooltip_copy_cat_crafts: "Copiar chaves de craft vinculadas a esta categoria", tooltip_copy_table_crafts: "Copiar chaves de craft vinculadas a esta mesa", mult_sell_short: "Mult. Venda", mult_buy_short: "Mult. Compra", margin_p2p_short: "Margem P2P", tip_mult_sell_short: "Multiplicador de Venda Específico. Deixe vazio para usar Global.", tip_mult_buy_short: "Multiplicador de Compra Específico. Deixe vazio para usar Global.", tip_margin_p2p_short: "Margem P2P Específica. Deixe vazio para usar Global.", tooltip_auto_cat_single: "IA: Sugerir categoria com base no nome", tooltip_auto_cat_global: "IA: Categorizar todos os itens sem categoria", toast_auto_cat_start: "✨ Analisando categorias...", toast_auto_cat_success: "{0} itens categorizados com sucesso!", toast_no_uncategorized: "Não há itens sem categoria para processar.",
       ...
       lbl_asset_upkeep: "Valor da Manutenção ($)",
    ...
    en: {
       ...
       lbl_asset_upkeep: "Upkeep Amount ($)",
    ...
    de: {
       ...
       lbl_asset_upkeep: "Unterhalt Wert ($)",
    ...
    ru: {
       ...
       lbl_asset_upkeep: "Сумма обслуживания ($)",
